...
\begin{itemize}
    \item \textbf{Uzly:} Každý uzel reprezentuje herní pozici. Pod uzlem je zobrazen hráč, který je na tahu (I nebo II).
...
Algoritmus pro každou pozici \( p \) určuje, zda je výherní pro Hráče I:
...
\begin{itemize}
    ...
    \item \textbf{Pozice Hráče I:} Hráč I vyhrává, pokud existuje alespoň jedna cesta do výherní pozice. 
