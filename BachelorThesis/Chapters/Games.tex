...
Třída \texttt{GamePosition} modeluje jednotlivou herní pozici jako uzel grafu. Každá instance uchovává identifikátor hráče, který je v dané pozici na tahu, spolu se seznamy předchůdců a následníků. Tyto seznamy umožňují efektivní navigaci grafem při retrográdní analýze i při zobrazování možných tahů.
