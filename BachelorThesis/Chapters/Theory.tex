...
\paragraph{Zdůvodnění korektnosti}
...
\begin{enumerate}
    \item Každému uzlu obvodu je přiřazen neterminál gramatiky.
    ...
    \item Pokud neterminál $X$ reprezentuje proměnnou s hodnotou 1, je přidáno pravidlo $X \to t$, kde $t$ je terminál.
    \item Pokud neterminál $X$ reprezentuje proměnnou s hodnotou 0, produkční pravidlo se nepřidává.
\end{enumerate}
...
\begin{itemize}
    \item \textbf{Proměnná 1:} Z pravidla $X \to t$ plyne, že $X$ je produktivní.
    \item \textbf{Proměnná 0:} Pro $X$ se nevytvoří žádné pravidlo, takže $X$ není produktivní.
