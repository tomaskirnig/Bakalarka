...
\begin{itemize}
    ...
    \item \textbf{Proměnná s hodnotou 1} vytvoří pravidlo $X \to t$, kde $t$ je terminál bez dalších odvozovacích pravidel.
    
    \item \textbf{Proměnná s hodnotou 0} generuje epsilon pravidlo $X \to \varepsilon$, což umožňuje odvození prázdného řetězce.
\end{itemize}
