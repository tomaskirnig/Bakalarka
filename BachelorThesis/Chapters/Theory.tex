...
\begin{itemize}
    \item \textbf{Vstup:} Orientovaný graf, kde každý uzel představuje herní pozici přiřazenou Hráči I nebo Hráči II, hrany reprezentují možné tahy a jeden uzel je označen jako startovní pozice.
