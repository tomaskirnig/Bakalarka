...
\begin{itemize}
    ...
    \item \textbf{Informační panely:} Modální okna nebo postranní panely zobrazující detaily o probíhajícím výpočtu nebo krokovatelném převodu (viz obrázek \ref{fig:ui-info-panel}).
\end{itemize}
...
Pro vizualizaci byla použita knihovna \emph{react-force-graph} \cite{reactforcegraph2024}, která pomocí fyzikální simulace automaticky rozmísťuje uzly a hrany. Stylování je realizováno frameworkem \emph{Bootstrap 5} \cite{bootstrap2024}, který zajišťuje jednotný vzhled.