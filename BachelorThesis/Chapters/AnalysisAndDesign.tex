...
Pro vizualizaci byla použita knihovna \emph{react-force-graph} \cite{reactforcegraph2024}, která k~výpočtu fyzikální simulace pro automatické rozmísťování uzlů a hran využívá engine \emph{D3.js} \cite{d3js2024}. Stylování je realizováno frameworkem \emph{Bootstrap 5} \cite{bootstrap2024}, který zajišťuje jednotný vzhled.