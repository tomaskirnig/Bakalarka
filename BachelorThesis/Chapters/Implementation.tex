...
Funkce \texttt{getOptimalMoves()} identifikuje hrany, které jsou součástí výherní strategie \cite{sawa}. Hrana z pozice \( u \) do pozice \( v \) je optimální, pokud obě pozice jsou výherní pro Hráče I. Tyto hrany jsou zvýrazněny ve vizualizaci.
...
\begin{enumerate}
    ...
    \item \textbf{Určení počáteční pozice:} Kořen MCVP stromu se automaticky stává počáteční pozicí hry, která je ve vizualizaci označena odlišnou barvou.
\end{enumerate}
...
Druhá fáze algoritmu prochází stromem a vytváří pravidla:
