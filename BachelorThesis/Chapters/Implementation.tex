...
Všec \texttt{DisplayGraph} pro vizualizaci herního grafu (viz sekce \ref{sec:GamesVisualizationImpl}).  
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{IMGs/explainCG.png}
...
\begin{itemize}
    ...
    \item \textbf{Vysvětlení kroku:} Popis toho, co se v daném kroku děje (nalezení koncové pozice, propagace výsledku).
