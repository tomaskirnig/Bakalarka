...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|p{10cm}|}
        ...
        \texttt{index.html} & Vstupní HTML soubor aplikace a hlavní bod pro načtení JavaScriptového kódu. \\ \hline
        \texttt{package.json} & Konfigurační soubor Node.js obsahující seznam závislostí a skriptů. \\ \hline
        \texttt{package-lock.json} & Soubor definující přesné verze nainstalovaných závislostí pro zajištění reprodukovatelnosti sestavení. \\ \hline
