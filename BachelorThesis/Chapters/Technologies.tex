...
Pro vizualizaci grafů používá aplikace knihovnu \emph{D3.js} \cite{d3js2024}. Grafy jsou automaticky rozmístěny – uzly se vzájemně odpuzují a hrany je přitahují k sobě. Pro stromové struktury v MCVP modulu (viz kapitola \ref{sec:MCVP}) jsou uzly uspořádány do úrovní shora dolů, s kořenem nahoře a listy dole.
