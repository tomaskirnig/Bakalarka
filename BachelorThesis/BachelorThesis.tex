...
\CzechKeywords{P-úplnost, teorie složitosti, Monotone Circuit Value Problem, logaritmické redukce, kombinatorické hry na grafu, problém neprázdnosti jazyka bezkontextové gramatiky, React, vizualizace algoritmů}
...
\EnglishKeywords{P-completeness, complexity theory, Monotone Circuit Value Problem, logspace reductions, combinatorial games on graphs, context-free grammar non-emptiness problem, React, algorithm visualization}
