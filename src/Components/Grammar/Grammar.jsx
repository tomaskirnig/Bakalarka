      ...
      <div className="page-controls">
        ...
        <InfoButton title="Problém neprázdnosti gramatiky">
          ...
          <ul className="ps-3 mb-2">
            <li>
              <strong>Oddělte symboly mezerami:</strong> <code>S → a S</code> (správně) vs{' '}
              <code>S → aS</code> (špatně)
            </li>
            <li>
              <strong>První písmeno velké (i české) = neterminály:</strong> S, A1, Abc, Č1, A_10
            </li>
            <li>
              <strong>Vše ostatní = terminály:</strong> a, +, id, number, 1a
            </li>
            <li>První neterminál na prvním řádku je počáteční symbol</li>
            <li>
              Použijte <code>|</code> pro oddělení alternativ
            </li>
            <li>
              Použijte <code>ε</code> nebo <code>epsilon</code> pro prázdný řetězec
            </li>
          </ul>
        </InfoButton>
      </div>
      ...
      <div className="page-content">
        <GenericInputMethodSelector
          ...
          renderContent={(opt) => {
            switch (opt) {
              case 'manual':
                return <ManualInput onGrammar={setGrammar} />;
              case 'generate':
                return <GenerateInput onGrammar={setGrammar} />;
              case 'sets':
                return <PreparedSetsInput onGrammar={setGrammar} />;
              default:
                return null;
            }
          }}
          ...
          <div className="mt-4 mb-4">
            ...
            <div className="card mt-3">
              ...
              <div className="card-body">
                <p
                  className={`alert ${!analysisResult.isEmpty ? 'alert-success' : 'alert-warning'}`}
                >
